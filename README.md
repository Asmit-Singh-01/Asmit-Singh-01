...
# 💫 About Me:
I am a Computer Science student and an independent Systems Architect and Technical Researcher. Operating from first principles to design autonomous software-hardware pipelines, explore reasoning model limits, and build high-leverage infrastructure.

* 🎓 **Core Focus:** Computer Science & Systems Engineering
* 💻 **Technical Domain:** Systems Architecture, Linux Automation, and AI Benchmarking
* 🔬 **Current Research:** Stress-testing Large Language Models to map where multi-step reasoning pipelines break down
